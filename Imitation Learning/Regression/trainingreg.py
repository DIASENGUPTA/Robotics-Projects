...
from networkreg import ClassificationNetwork
...
def train(data_folder, save_path):
    ...
    criterion=nn.MSELoss()#used Mean-squared error loss as the loss
    ...
    plt.savefig('/projectnb/rlvn/students/ksg25/PythonAPI/examples/Lossreg2.jpg')
