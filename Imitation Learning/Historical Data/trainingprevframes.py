...
from networkprevframes import ClassificationNetwork
from modifieddataset import get_dataloader
...
def train(data_folder, save_path):
    ...
    plt.savefig('/projectnb/rlvn/students/ksg25/PythonAPI/examples/Prevvalueswithplot123.jpg')
